...
public class ArcusCosinus {
    ...
    private static final String EXCEPTION_MESSAGE = "There is a mistake in the arcus cosinus expression.";
    private static final String NUMBER_PATTERN = "\\d+";
    private static final String SPACE_PATTERN = "\\s*";
    private static final String PREFIX_ARCUS_COSINUS = "arccos";
    private static final String OPENING_BRACKET = "\\(";
    private static final String CLOSING_BRACKET = "\\)";
    private static final String ARCUS_COSINUS_PATTERN = PREFIX_ARCUS_COSINUS + OPENING_BRACKET + SPACE_PATTERN
            + NUMBER_PATTERN + SPACE_PATTERN + CLOSING_BRACKET;
